...
/* @@protoc_insertion_point(class_definition:protobuff.TaskRequest) */ {
 ...
 public:
  ...
  template <typename Arg_ = const std::string&, typename... Args_>
  void set_consumer_id(Arg_&& arg, Args_... args);
  std::string* mutable_consumer_id();
  PROTOBUF_NODISCARD std::string* release_consumer_id();
  void set_allocated_consumer_id(std::string* value);

  private:
  const std::string& _internal_consumer_id() const;
  inline PROTOBUF_ALWAYS_INLINE void _internal_set_consumer_id(
      const std::string& value);
...
// string consumer_id = 1;
inline void TaskRequest::clear_consumer_id() {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  _impl_.consumer_id_.ClearToEmpty();
}
inline const std::string& TaskRequest::consumer_id() const
    ABSL_ATTRIBUTE_LIFETIME_BOUND {
  // @@protoc_insertion_point(field_get:protobuff.TaskRequest.consumer_id)
  return _internal_consumer_id();
}
template <typename Arg_, typename... Args_>
inline PROTOBUF_ALWAYS_INLINE void TaskRequest::set_consumer_id(Arg_&& arg,
                                                     Args_... args) {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  _impl_.consumer_id_.Set(static_cast<Arg_&&>(arg), args..., GetArena());
  // @@protoc_insertion_point(field_set:protobuff.TaskRequest.consumer_id)
}
inline std::string* TaskRequest::mutable_consumer_id() ABSL_ATTRIBUTE_LIFETIME_BOUND {
  std::string* _s = _internal_mutable_consumer_id();
  // @@protoc_insertion_point(field_mutable:protobuff.TaskRequest.consumer_id)
  return _s;
}
inline const std::string& TaskRequest::_internal_consumer_id() const {
  ::google::protobuf::internal::TSanRead(&_impl_);
  return _impl_.consumer_id_.Get();
}
inline void TaskRequest::_internal_set_consumer_id(const std::string& value) {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  _impl_.consumer_id_.Set(value, GetArena());
}
inline std::string* TaskRequest::_internal_mutable_consumer_id() {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  return _impl_.consumer_id_.Mutable( GetArena());
}
inline std::string* TaskRequest::release_consumer_id() {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  // @@protoc_insertion_point(field_release:protobuff.TaskRequest.consumer_id)
  return _impl_.consumer_id_.Release();
}
inline void TaskRequest::set_allocated_consumer_id(std::string* value) {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  _impl_.consumer_id_.SetAllocated(value, GetArena());
  if (::google::protobuf::internal::DebugHardenForceCopyDefaultString() && _impl_.consumer_id_.IsDefault()) {
    _impl_.consumer_id_.Set("", GetArena());
  }
  // @@protoc_insertion_point(field_set_allocated:protobuff.TaskRequest.consumer_id)
}
